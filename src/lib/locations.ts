...
export const COUNTRY_CITIES: Record<string, string[]> = {
  "Azerbaijan": [
    "Agdam", "Agdash", "Agjabadi", "Agstafa", "Astara", "Baku", "Balakan", "Barda", "Beylagan",
    "Bilasuvar", "Dashkasan", "Fuzuli", "Gabala", "Ganja", "Gakh", "Gobustan", "Goranboy",
    "Goychay", "Goygol", "Hajigabul", "Imishli", "Ismailli", "Jabrayil", "Jalilabad", "Kalbajar",
    "Khachmaz", "Khizi", "Kurdamir", "Lachin", "Lankaran", "Lerik", "Masally", "Mingachevir",
    "Nakhchivan", "Neftchala", "Oghuz", "Qabala", "Qakh", "Qazax", "Quba", "Qusar", "Saatly",
    "Sabirabad", "Salyan", "Samukh", "Shabran", "Shaki", "Shamakhi", "Shirvan", "Siazan",
    "Sumgait", "Tartar", "Tovuz", "Ujar", "Yardimli", "Yevlakh", "Zagatala", "Zardab",
  ],
  ...
  "Russia": [
    "Abakan", "Anadyr", "Arkhangelsk", "Astrakhan", "Barnaul", "Belgorod", "Birobizhan",
    "Blagoveshchensk", "Bryansk", "Cheboksary", "Chelyabinsk", "Cherkessk", "Chita",
    "Elista", "Grozny", "Irkutsk", "Ivanovo", "Izhevsk", "Kaliningrad", "Kaluga", "Kazan",
    "Kemerovo", "Khabarovsk", "Khanty-Mansiysk", "Kirov", "Kostroma", "Krasnodar",
    "Krasnoyarsk", "Kurgan", "Kursk", "Kyzyl", "Lipetsk", "Magadan", "Magnitogorsk",
    "Makhachkala", "Maykop", "Moscow", "Murmansk", "Naberezhnye Chelny", "Nalchik",
    "Naryan-Mar", "Nizhny Novgorod", "Novokuznetsk", "Novosibirsk", "Omsk", "Orenburg",
    "Oryol", "Penza", "Perm", "Petropavlovsk-Kamchatsky", "Pskov", "Rostov-on-Don",
    "Ryazan", "Saint Petersburg", "Salekhard", "Samara", "Saratov", "Smolensk", "Sochi",
    "Stavropol", "Syktyvkar", "Tambov", "Tolyatti", "Tomsk", "Tula", "Tver", "Tyumen",
    "Ufa", "Ulan-Ude", "Ulyanovsk", "Vladikavkaz", "Vladivostok", "Volgograd", "Vologda",
    "Voronezh", "Yakutsk", "Yaroslavl", "Yekaterinburg", "Yoshkar-Ola",
  ],
